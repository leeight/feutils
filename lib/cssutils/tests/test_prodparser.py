    ...
    def test_nextProd(self):
        ...
        tests = {
            ...
            (p2, ): ([(t2, p2)],
                     [(t1, 'Missing token for production p2')],
                     [(t2, p2), (t2, p2)],
                     [(t2, p2), (t1, 'No matching production for token')],
...
class ChoiceTestCase(basetest.BaseTestCase):
    ...
    def test_init(self):
        ...
        ch = Choice(p1, p2)
        self.assertRaisesMsg(ParseError, 'No match in Choice(p1, p2)', ch.nextProd, t0)
    ...
    def test_nested(self):
        ...
        ch = Choice(s1, s2)
        self.assertRaisesMsg(ParseError, 'No match in Choice(Sequence(p1, p1), Sequence(p2, p2))', ch.nextProd, t0)
