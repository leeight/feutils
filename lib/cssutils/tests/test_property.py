...
#            self.assert_(v.wellformed, True)
    ...
    def test_cssText(self):
        ...
        tests = {
            ...
            'a !': (xml.dom.SyntaxErr,
                     'Property: No ":" after name found: a ! [1:3: !]'),
            'a:': (xml.dom.SyntaxErr,
                    'Property: No property value found: a: [1:2: :]'),
            '/**/a': (xml.dom.SyntaxErr,
                       'Property: No ":" after name found: /**/a [1:5: a]'),
            # somehow 'a: ' fails?!?
            'a111: ': (xml.dom.SyntaxErr,
                   "PropertyValue: Unknown syntax or no value:  "),
            'a: 1!': (xml.dom.SyntaxErr,
                       'Property: Invalid priority: !'),
            'a: 1!importantX': (xml.dom.SyntaxErr,
                   "Property: No CSS priority value: importantx"),
            'a:!important': (xml.dom.SyntaxErr,
                   "PropertyValue: Unknown syntax or no value: "),
