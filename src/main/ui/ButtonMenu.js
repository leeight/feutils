 ...
 * @type {string}
 */
ui.ButtonMenu.prototype.tpl = '<div id="{2}" class="{1}">{0}</div><div class="{3}"></div>';

/**
 * @private
 * @type {boolean}
 */
ui.ButtonMenu.prototype.isRender = false;

/** @inheritDoc */
ui.ButtonMenu.prototype.render = function(opt_main) {
    var me = this,
 ...
 * @return {string}
 */
ui.ButtonMenu.prototype.getMainHtml = function() {
    var me = this;
 ...
 * @private
 */
ui.ButtonMenu.prototype.initBehavior = function() {
    var me = this;
 ...
 * @inheritDoc
 */
ui.ButtonMenu.prototype.dispose = function() {
