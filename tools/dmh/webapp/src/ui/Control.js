 ...
 * $Id: Control.js 5298 2011-05-06 13:58:58Z liyubei $
 *
 **************************************************************************/
...
/**
 * FIXME 这个方法足够了吗？有的控件是在render函数的很前面
 * 调用superClass.render.call(this)，
 * 然后再后面调用this.isRendered()，其实就没有什么效果了.
 * @return {boolean} 判断一个控件是否已经渲染完毕了.
 */
ui.Control.prototype.isRendered = function() {
    return this.lifePhase >= ui.lifeCycle.EVENT_BOUND;
}
