...
goog.include('ui/Orientation.html');
goog.include('css/ui-orient.css');

goog.provide('ui.Orientation');
...
ui.Orientation.prototype = (function() {
    ...
    var selectorModuleMap = {
        ...
        region: {
             ...
             *
             * @private
             * @param {HTMLElement} control 初始化的dom元素.
             */
    ...
    return {
         ...
         * @param {number} openFlag true:根据hasValue判断是否显示结果区
         * @private
         */
