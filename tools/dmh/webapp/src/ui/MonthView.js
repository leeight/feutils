...
ui.MonthView.prototype = /** @lends {ui.MonthView.prototype} */ {
    /**
     * 日期的模板
     * @private
     */
    ...
    getHtml: function() {
        var me = this,
            html = ['<table border="0" cellpadding="0" cellspacing="0" class="' +
                    me.getClass('main') + '"><thead><tr>'],
            index = 0,
            year = me.year,
            month = me.month,
