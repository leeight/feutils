 ...
 * desc:    对话框控件
 * author:  zhaolei,erik
 * date:    $Date: 2011-06-13 15:58:20 +0800 (周一, 13 六月 2011) $
 */

goog.require('ui.Control');
goog.require('ui.Mask');
goog.require('ui.events.keyCodes');
 ...
 * @type {string}
 */
ui.Dialog.prototype.tplBF = '<div class="{1}" id="{0}">{2}</div>';
 ...
 * @return {Function}
 */
ui.Dialog.prototype.getKeyHandler = function() {
    var me = this;
    ...
    return function(e) {
        if (me.isShow) {
            ...
            if (keyCode == ui.events.keyCodes.ESC) {
                me.close();
            }
        }
    }
 ...
 * @protected
 */
ui.Dialog.prototype.onclose = baidu.fn.blank;
...
ui.Dialog.prototype.bindEvent = function() {
    ...
    if (this.closeButton !== false) {
        ...
        if (this.keyHandler == null) {
            ...
            baidu.on(document, 'keypress', this.keyHandler);
        }
    }
};
...
ui.Dialog.prototype.dispose = function() {
    ...
    if (this.keyHandler) {
        baidu.un(document, 'keypress', this.keyHandler);
        this.keyHandler = null;
    }
