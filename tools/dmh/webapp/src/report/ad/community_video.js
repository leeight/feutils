 ...
 * 广告生活圈视频报告
 */
report.ad.CommunityVideo = function() {
    er.ListAction.call(this);
};

report.ad.CommunityVideo.prototype = {
    view: 'communityVideo',
    ...
    afterInit: function(page) {
        ...
        this.requesterList = report.data['ad.community_video'];
    },
...
baidu.inherits(report.ad.CommunityVideo, er.ListAction);
