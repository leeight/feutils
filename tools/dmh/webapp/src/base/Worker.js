 ...
 * @param {base.AbstractWorker} worker 要添加的worker.
 */
...
/**
 * 删除一个Worker
 * @param {base.AbstractWorker} worker 要删除的worker.
 */
...
/**
 * @private
 * @param {base.AbstractWorker} worker 已经完成工作的worker.
 */
