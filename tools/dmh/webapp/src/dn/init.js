 ...
 * date:    $Date: 2011-05-05 00:09:37 +0800 (周四, 05 五月 2011) $
 */
...
dn.init = (function() {
    ...
    function initer() {
        // 初始化导航
        var nav = dn.navigator;
        nav.register(dn.config.navigator);
        er.locator.onredirect = nav.repaint;
        nav.render();
    ...
    er.template.setObjectGetter(function(type, varName){
      return String(baidu.getObjectByName('dn.' + type + '.' + varName));
    });
