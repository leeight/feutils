...
# file root , log file
#
FILE_ROOT=$EXPORT_FILE_PLANNING_FORECASTING_ROOT/forecasting
LOG_FILE=${EXPORT_FILE_PLANNING_FORECASTING_ROOT}/forecastingLog.export
...
# execute the command
#
ant -f toolsBuild.xml forecastingTask -DfilePath=${FILE_ROOT} >> $LOG_FILE 2>&1
