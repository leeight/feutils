 ...
 *
 * path:    base/PropertyChangeNotifier.js
 * desc:    属性变化会通知所有监听器的类
...
goog.provide('base.PropertyChangeNotifier');
...
base.PropertyChangeNotifier.prototype = (function() {
    ...
    function baseSet(value, propertyName) {
        ...
        this.trigger(base.PropertyChangeNotifier.PropertyChangedEvent, propertyName, value, oldValue);
    }
    ...
    function initSetters() {
        ...
        for (propertyName in this) {
            if (typeof this[propertyName] !== 'function' && propertyName.charAt(0) !== '_') {
                upperCase = propertyName.charAt(0).toUpperCase() + propertyName.substring(1);
    ...
    /**
     * @lends {base.PropertyChangeNotifier.prototype}
     */
    return {
        /**
         ...
         * @param {Function} listener 监听器，参数表为(propertyName, newValue, oldValue)。.
         */
        addPropertyChangedListener: function(listener) {
            ...
            this.addListener(base.PropertyChangeNotifier.PropertyChangedEvent, listener);
        },
        ...
        removePropertyChangedListener: function(listener) {
            this.removeListener(base.PropertyChangeNotifier.PropertyChangedEvent, listener);
        },
        ...
        triggerPropertyChanged: function(propertyName) {
            this.trigger(base.PropertyChangeNotifier.PropertyChangedEvent,
