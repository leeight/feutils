...
goog.provide('base.ObservableList');
 ...
 */
base.ObservableList = function(array) {
...
base.ObservableList.prototype = (function() {
    /**
    ...
    function triggerListeners(action, newItems, olditems) {
        this.trigger(base.ObservableList.ListChangedEvent, action, newItems, olditems);
    }
    ...
    var proto = {
        ...
        addListChangedListener: function(listener) {
            this.addListener(base.ObservableList.ListChangedEvent, listener);
        },
        ...
        removeListChangedListener: function(listener) {
            this.removeListener(base.ObservableList.ListChangedEvent, listener);
        },
        ...
        splice: function() {
            ...
            if (arguments.length > 2) {
                ...
                if (arguments[1] === 0) {
                    ...
                    triggerListeners.call(this, listAction.REPALCE, newItems, ret);
                }
            } else {
                triggerListeners.call(this, listAction.REMOVE, [], ret);
            }
...
base.ObservableList.ListChangedEvent = 'LIST_CHANGED';
baidu.inherits(base.ObservableList, base.EventDispatcher);
