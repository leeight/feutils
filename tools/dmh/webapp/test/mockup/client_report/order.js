...
mockup.register('/client_report/order/daily', orderDailyReport);
...
mockup.register('/client_report/order/location', orderLocationReport);
...
mockup.register('/client_report/order/perhour', orderHourReport);
...
mockup.register('/client_report/order/frequency', orderFrequencyReport);
...
mockup.register('/client_report/order/ad_video', orderAdVideoReport);
...
mockup.register('/client_report/order/ad_non_video', orderAdNonVideoReport);
